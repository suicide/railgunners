...
pub(crate) struct ShareableViewingKeyInspection {
    ...
    nullifying_key: railgunners_types::NullifyingKey,
    master_public_key: railgunners_types::MasterPublicKey,
...
impl ShareableViewingKeyInspection {
    ...
    #[must_use]
    pub(crate) const fn nullifying_key(&self) -> &railgunners_types::NullifyingKey {
        &self.nullifying_key
    }
    #[must_use]
    pub(crate) const fn master_public_key(&self) -> &railgunners_types::MasterPublicKey {
...
pub(crate) enum ShareableViewingKeyInspectionError {
    ShareableViewingKey(railgunners_core::ShareableViewingKeyError),
    KeyDerivation,
...
impl From<railgunners_core::ShareableViewingKeyError> for ShareableViewingKeyInspectionError {
    fn from(value: railgunners_core::ShareableViewingKeyError) -> Self {
