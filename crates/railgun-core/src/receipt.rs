...
mod tests {
    ...
    fn address(byte: u8) -> railgun_types::Address {
        railgun_types::Address::new([byte; 20])
    }
    ...
    fn inspects_successful_v2_receipt_into_summary_and_ordered_events() {
        ...
        let crate::DecodedRailgunLogEvent::Commitment(railgun_types::VersionedCommitmentEvent::V2(
            event,
