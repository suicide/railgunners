...
mod tests {
    ...
    fn preserves_normalized_result_shape() {
        ...
        let expected = CommitmentSummary::new(
            commitment("29decce78b2f43c718ebb7c6825617ea6881836d88d9551dd2530c44f0d790c5"),
            VersionedCommitmentCiphertext::V3(railgun_types::CommitmentCiphertextV3::new(
                railgun_types::V3CiphertextBundle::new(
                    V3StoredNonce::new([1_u8; 16]),
                    vec![2_u8, 3_u8, 4_u8],
                    Vec::new(),
                ),
                railgun_types::BlindedViewingPublicKey::new([5_u8; 32]),
                railgun_types::BlindedViewingPublicKey::new([6_u8; 32]),
            )),
        );
