...
fn encode_commitment_ciphertext(
    commitment_ciphertext: &railgun_types::CommitmentCiphertextV2,
...
) -> Result<railgun_types::CommitmentCiphertextV2, V2BoundParamsError> {
...
fn from_abi(bound_params: &V2BoundParamsAbi) -> Result<V2BoundParams, V2BoundParamsError> {
    ...
    let chain_id = railgun_types::ChainId::new(bound_params.chainID)
    ...
    Ok(V2BoundParams::new(
        ...
        unshield,
        chain_id,
        railgun_types::Address::from_slice(bound_params.adaptContract.as_slice())
            .map_err(|error| parse_domain_error(&error))?,
        adapt_params,
        commitment_ciphertext,
    ))
...
mod tests {
    ...
    fn zero_vector_bound_params() -> V2BoundParams {
        let commitment_ciphertext = railgun_types::CommitmentCiphertextV2::new(
        ...
        V2BoundParams::new(
            ...
            V2UnshieldFlag::None,
            railgun_types::ChainId::new(1).unwrap_or_else(|_| panic!("chain id should be valid")),
            Address::new([0_u8; 20]),
    ...
    fn preserves_normalized_v2_ciphertext_word_order() {
        let bound_params = V2BoundParams::new(
            ...
            Address::new([0_u8; 20]),
            AdaptParams::new([0_u8; 32]),
            vec![railgun_types::CommitmentCiphertextV2::new(
                V2CiphertextBundle::new(
