...
mod tests {
    ...
    fn packed_spending_public_key_hex() -> String {
        let spending_public_key =
            railgun_core::derive_spending_public_key(&railgun_types::SpendingPrivateKey::new(
        ...
        let packed = railgun_core::pack_spending_public_key(&spending_public_key)
    ...
    fn decodes_shareable_viewing_key_with_all_chains_default() {
        let packed_spending_public_key = packed_spending_public_key_hex();
        let shareable_viewing_key = railgun_core::encode_shareable_viewing_key(
            &railgun_types::ShareableViewingKeyData::new(
                railgun_types::ViewingPrivateKey::new(
                    hex::decode("67d7d19d00e6e3b3517fe68ac46505dd207df6e8fe3aa06ba3face352e7599ef")
                ...
                railgun_types::PackedSpendingPublicKey::new(
