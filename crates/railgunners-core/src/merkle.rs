...
mod tests {
    ...
    use num_traits::Num;
    use railgunners_types::{MerkleProofElement, MerkleProofIndices, MerkleRoot};
    ...
    fn verifies_proof_with_mixed_direction_bits() {
        ...
        let mut current = leaf;
        let mut elements = Vec::with_capacity(railgunners_types::TREE_DEPTH);

        for level in 0..railgunners_types::TREE_DEPTH {
