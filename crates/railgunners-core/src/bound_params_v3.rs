...
fn encode_commitment_ciphertext(
    commitment_ciphertext: &railgunners_types::CommitmentCiphertextV3,
) -> CommitmentCiphertextV3Abi {
    let mut ciphertext = Vec::with_capacity(
        railgunners_types::V3StoredNonce::LENGTH + commitment_ciphertext.bundle().len(),
    );
...
) -> Result<railgunners_types::CommitmentCiphertextV3, V3BoundParamsError> {
...
fn from_abi(bound_params: &V3BoundParamsAbi) -> Result<V3BoundParams, V3BoundParamsError> {
    ...
    let global = V3BoundParamsGlobal::new(
        ...
        railgunners_types::Address::from_slice(bound_params.global.to.as_slice())
    ...
    fn zero_vector_bound_params() -> V3BoundParams {
        V3BoundParams::new(
            V3BoundParamsLocal::new(
                0,
                vec![railgunners_types::CommitmentCiphertextV3::new(
