...
use railgunners_types::{PackedSpendingPublicKey, ShareableViewingKeyData, SpendingPublicKey};
...
pub fn decode_shareable_viewing_key(
    ...
    let viewing_private_key = railgunners_types::ViewingPrivateKey::from_slice(
...
mod tests {
    ...
    use railgunners_types::{ShareableViewingKeyData, SpendingPrivateKey, ViewingPrivateKey};
    use serde::Serialize;
    use serde_bytes::ByteBuf;
