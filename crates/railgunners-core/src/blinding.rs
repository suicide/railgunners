...
use railgunners_types::{BlindedViewingPublicKey, SenderRandom, SharedRandom, ViewingPublicKey};
...
mod tests {
    ...
    use railgunners_types::{
        BlindedViewingPublicKey, SenderRandom, SharedRandom, ViewingPrivateKey,
    };
