...
The current Poseidon backend is intentionally kept inside `railgunners-core::crypto` for this reason. It serves shared protocol behavior, must preserve exact Circom-compatible semantics, and does not yet justify a separate crate boundary.
